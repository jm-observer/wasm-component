...
// Use a procedural macro to generate bindings for the world we
// specified in `host.wit`
...
// Define a custom type and implement the generated `Guest` trait for
// it which represents implementing all the necessary exported
